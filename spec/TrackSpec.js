...
describe('Track', function () {
    ...
    it("should have an artist", function () {
        ...
        var track = new ScrobbleCloud.Track(null, 'Radioactive Man');
        expect(track.artist).toBe('Radioactive Man');
    });

    it("should have a creation time", function () {

        var track = new ScrobbleCloud.Track('Uranium', 'Radioactive Man');
        expect(track.created instanceof Date).toBe(true);
    });

    it("should match other tracks with the same info", function () {

        var track1 = new ScrobbleCloud.Track('Uranium', 'Radioactive Man');
        var track2 = new ScrobbleCloud.Track('Uranium', 'Radioactive Man');
